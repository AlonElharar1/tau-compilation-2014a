...
public class DeclVirtualMethodBuilder implements ASTNodeBuilder {
	...
	public Node Build(Tree parseTree, ASTBuilder buildHelper)
		...
		Tree methodHeaderTree = parseTree.subtrees.get(0);
		...
		return (new DeclVirtualMethod(returnType, name, parameters, statements));
	}
